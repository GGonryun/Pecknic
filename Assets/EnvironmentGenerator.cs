...
public class EnvironmentGenerator : MonoBehaviour
{
    ...
    [Range(50, 200)] [SerializeField] private float growthRate;
    [Range(0, .499f)] [SerializeField] private float offset;
        ...
        for (int z = zMin; z < zMax; z++)
        {
            for (int x = xMin; x < xMax; x++)
            {
                ...
                if (grow > growthRate)
                {
                    ...
                    obj.transform.position = new Vector3(x, (heightMap[x, z] * scale)-1f, z);
                    environment.Add(obj);
                }
            }
        }
